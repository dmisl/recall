...
<body style="margin: 0;">
     <div style="width: 100%; height: 100vh; display: flex; flex-direction: column; align-items: center; background-image: url('cool_image.jpg'); background-position: center; background-size: cover; background-repeat: no-repeat;">
          ...
          <div style="width: 1000px; height: 100%; display: flex; justify-content: center; align-items: center; background-color: rgba(255, 145, 233, 0.148);">
               <div style="width: 900px; position: relative; top: -100px; display: flex; justify-content: center; flex-wrap: wrap; align-items: center;">
